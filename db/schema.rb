...
ActiveRecord::Schema[7.0].define(version: 2022_11_03_235822) do
  ...
  create_table "reservas", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["bibliotecario_id"], name: "index_reservas_on_bibliotecario_id"
  ...
  add_foreign_key "reservas", "bibliotecarios"
